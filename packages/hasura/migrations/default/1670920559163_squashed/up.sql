...
INSERT INTO "quiz"."categories"("category_id", "category") VALUES (1, E'理系');

INSERT INTO "quiz"."categories"("category_id", "category") VALUES (2, E'文学');

INSERT INTO "quiz"."categories"("category_id", "category") VALUES (3, E'言葉');

INSERT INTO "quiz"."categories"("category_id", "category") VALUES (4, E'日本史');

INSERT INTO "quiz"."categories"("category_id", "category") VALUES (5, E'世界史');
...
INSERT INTO "quiz"."categories"("category_id", "category") VALUES (8, E'芸術');

INSERT INTO "quiz"."categories"("category_id", "category") VALUES (9, E'漫画・アニメ・ゲーム');

INSERT INTO "quiz"."categories"("category_id", "category") VALUES (10, E'生活');

INSERT INTO "quiz"."categories"("category_id", "category") VALUES (11, E'スポーツ');

INSERT INTO "quiz"."categories"("category_id", "category") VALUES (12, E'芸能');

INSERT INTO "quiz"."categories"("category_id", "category") VALUES (13, E'ノンセクション');
